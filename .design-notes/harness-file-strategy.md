...
- **行**: 97-105（コピー）, 438-445（sed-in-place）
...
- **行**: 75-78（旧）、449-456（新：usage ループに統合）
...
- **行**: 324-332（コピー）, 351-365（yori_version の sed-in-place）
...
## `.opencode/standards/tech-decision.md.template`
- **戦略**: C
- **元**: `$YORI_SRC/snippets/tech-decision.md.template`
- **行**: 283
- **理由**: ADR 用の参照テンプレート。ユーザーは内容をコピーして使うものであり、直接編集しない。
