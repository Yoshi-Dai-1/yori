...
dev-standards/
  ...
  principles/                   汎用原則（読む・参照する）
    ...
    naming-conventions.md       命名規則（基本・言語別・REST API・GraphQL・WebSocket・DB・セキュア命名・自律確定フロー）
    ...
    production-readiness.md     本番リリース前チェックリスト（9セクション：WebSocket・GraphQL・DBマイグレーション追加）
